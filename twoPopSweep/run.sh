...
do 
    ...
    ~/bin/selscan --vcf "neutralRep${i}/pp/0002.vcf" --vcf-ref "neutralRep${i}/pp/0003.vcf" --out "neutralRep${i}/twoPopSweep" --xpehh --xpnsl --pmap  --trunc-ok
    ~/bin/selscan --vcf "neutralRep${i}/pp/0002.vcf" --vcf-ref "neutralRep${i}/pp/0003.vcf" --out "neutralRep${i}/twoPopSweep.unphased" --unphased --xpehh --xpnsl --pmap  --trunc-ok
...
~/bin/selscan --vcf "sweep/pp/0002.vcf" --vcf-ref "sweep/pp/0003.vcf" --out "sweep/twoPopSweep" --xpehh --xpnsl --pmap --trunc-ok
~/bin/selscan --vcf "sweep/pp/0002.vcf" --vcf-ref "sweep/pp/0003.vcf" --out "sweep/twoPopSweep.unphased" --unphased --xpehh --xpnsl --pmap --trunc-ok
rm -rf "sweep/pp"

# Normalize w.r.t. neutral sims.
~/bin/norm --xpehh --files neutralRep*/twoPopSweep.xpehh.out sweep/twoPopSweep.xpehh.out --bins 100
~/bin/norm --xpnsl --files neutralRep*/twoPopSweep.xpnsl.out sweep/twoPopSweep.xpnsl.out --bins 100
~/bin/norm --xpehh --files neutralRep*/twoPopSweep.unphased.xpehh.out sweep/twoPopSweep.unphased.xpehh.out --bins 100
~/bin/norm --xpnsl --files neutralRep*/twoPopSweep.unphased.xpnsl.out sweep/twoPopSweep.unphased.xpnsl.out --bins 100
