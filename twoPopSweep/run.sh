...
python3 ../recap.py 1 "${tree}" "./sweep/twoPopSweep"
...
selscan norm --xpehh --files neutralRep*/twoPopSweep.xpehh.out sweep/twoPopSweep.xpehh.out --bins 100
selscan norm --xpnsl --files neutralRep*/twoPopSweep.xpnsl.out sweep/twoPopSweep.xpnsl.out --bins 100